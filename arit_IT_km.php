...
<body>
    ...
    <div class="container">
      <div class="row">
            ...
            <div class="col-sm-9">
            <div class="card">
            <h4 class="card-header">ความรู้ด้านเทคโนโลยีสารสนเทศ</h4>
            <div class="card-body">
                <ul>
                    <li>ประกาศ - <a href="Document/20070618_CC_Final.pdf" target="_blank">พร.บ. ว่าด้วยการกระทำผิดเกี่ยวกับคอมพิวเตอร์ ฉบับ การ์ตูน</a></li>
                    <li>ประกาศ - <a href="Document/law_com.pdf" target="_blank">พร.บ. ว่าด้วยการกระทำผิดเกี่ยวกับคอมพิวเตอร์</a></li>
                    <li>ประกาศ - <a href="Document/TrafficData.pdf" target="_blank">ประกาศกระทรวงเทคโนโลยีสารสนเทศ และการสื่อสาร เรื่อง หลักเกณฑ์การเก็บรักษาข้อมูลจราจรทางคอมพิวเตอร์ของผู้ให้บริการ</a></li>
                </ul>  
            </div>
            </div>
