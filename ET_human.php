                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item">
                                        <a href="ET_Asean.php">
                                        <img class="d-block w-100" src="img/aseancartoon.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a href="http://www.vod.rbru.ac.th/" target="blank">
                                        <img class="d-block w-100" src="img/bannervod.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item active">
                                        <a href="ET_U_logo.php">
...
<!------------------------------------------------------------------------------------->
                        ...
                        <div class="card">
                            <h4 class="card-header"><center>บุคลากรศูนย์เทคโนโลยีการศึกษา</center></h4>
                            <div class="card-body">
                                <table style="border-collapse:collapse; border:none" border="0">
                                    <tbody>
                                            <tr>
                                        <td colspan="3"><center><img src="img\human/pongnatee.jpg"></center></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><center><img src="img\human/noppadate.jpg" alt=""></center></td>
                                        <td width="25%"><center><img src="img\human/surat.jpg" alt=""></center></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><center><img src="img/ronnapob.jpg" alt=""></center></td>
