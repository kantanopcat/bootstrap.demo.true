    ...
    <div class="container">
      <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <div class="card">
                        <h4 class="card-header">ปรัชญา วิสัยทัศน์ พันธกิจ</h4>
                    <div class="card-body">

                                <h5>ปรัชญา (Philosophy) :   </h5>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;องค์กรก้าวหน้า พัฒนาเทคโนโลยีสารสนเทศ</p>
                                <h5>วิสัยทัศน์ (Vision) :  </h5>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เป็นศูนย์กลางในการนำเทคโนโลยีสารสนเทศมาใช้ให้เกิดประโยชน์แก่มหาวิทยาลัยและท้องถิ่น</p>
                                <h5>พันธกิจ (Missions) :  </h5>
                            <ul>
                                <li> 1. พัฒนาโครงสร้างพื้นฐานและขยายระบบเครือข่ายให้มีเสถียรภาพและครอบคลุมทุกหน่วยงานในมหาวิทยาลัย</li>
                                <li> 2. สนับสนุนและส่งเสริมการให้บริการทางวิชาการด้านเทคโนโลยีสารสนเทศสู่ท้องถิ่น</li>
                                <li> 3. พัฒนาศักยภาพด้านเทคโนโลยีสารสนเทศของนักศึกษาและบุคลากรของมหาวิทยาลัย</li>
                                <li> 4. พัฒนาระบบสารสนเทศเพื่อสนับสนุนระบบการเรียนการสอน การวิจัย และการบริหารงานของมหาวิทยาลัย</li>
                            </ul>
                    </div>  
                </div>
